...
void MPUHandler::getData(float &ax, float &ay, float &az, float &gx, float &gy, float &gz) {
...
void MPUHandler::calibrateAccelerometer() {
  ...
  for (int i = 0; i < numSamples; i++) {
    ...
    Serial.println("ax: " + String(ax) + " | sum: " + String(sumXOffset) + " | ay: " + String(ay) + " | sum: " + String(sumYOffset) + " | az: " + String(az) + " | sum: " + String(sumZOffset));
    delay(10);
  }
  ...
  Serial.println("X: " + String(accelXOffset) + " | Y: " + String(accelYOffset) + " | Z: " + String(accelZOffset));
  Serial.println("Accelerometer Calibration Complete.");
}

void MPUHandler::calibrateGyroscope() {
  ...
  for (int i = 0; i < numSamples; i++) {
    ...
    Serial.println("gx: " + String(gx) + " | sum: " + String(sumXOffset) + " | gy: " + String(gy) + " | sum: " + String(sumYOffset) + " | gz: " + String(gz) + " | sum: " + String(sumZOffset));
    delay(10);
  }
  ...
  Serial.println("X: " + String(gyroXOffset) + " | Y: " + String(gyroYOffset) + " | Z: " + String(gyroZOffset));
